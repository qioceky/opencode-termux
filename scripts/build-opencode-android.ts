 ...
 * This script:
 * 1. Loads migrations
 * 2. Bundles OpenCode using Bun.build() with compile targeting the host platform
 * 3. Extracts the module graph from the compiled binary
 * 4. Appends it to our Android bun binary to create the final standalone
 */
...
// Step 1: Load migrations
console.log("\n=== Step 1: Loading migrations ===")
const migrationDirs = (
...
// Step 3: Extract module graph from host binary
console.log("\n=== Step 3: Extracting module graph ===")
...
// Step 4: Patch the module graph for Android
console.log("\n=== Step 4: Patching module graph for Android ===")
...
// Step 5: Create Android standalone binary
console.log("\n=== Step 5: Creating Android standalone binary ===")
